import { getAllBlockedTabs, addBlockedTab, deleteBlockedTab, resetBlockedTabs } from "../backend/BlockWebsiteTab.js";
      ...
      <div className="BlockWebsiteTab">
        ...
        <ul>
          {blockedTabs.map((tab, index) => (
            <div key={index}>
				<button className="removeButton" onClick={() => this.removeBlockedTab(index)}>-</button>
              <span>{tab}</span>
            </div>
          ))}
        </ul>
